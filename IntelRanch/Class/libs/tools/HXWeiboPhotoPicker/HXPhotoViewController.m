 ...
 */
- (void)didPhotoBottomViewClick:(HXPhotoBottomType)type Buttons:(UIButton *)button {
...
- (void)didPreviewClick:(UIButton *)button {
    if ([self.delegate respondsToSelector:@selector(didPhotoBottomViewClick:Buttons:)]) {
        [self.delegate didPhotoBottomViewClick:HXPhotoBottomTyPepreview Buttons:button];
    }
}
- (void)didOriginalClick:(UIButton *)button {
    button.selected = !button.selected;
    if ([self.delegate respondsToSelector:@selector(didPhotoBottomViewClick:Buttons:)]) {
        [self.delegate didPhotoBottomViewClick:HXPhotoBottomTyOriginalPhoto Buttons:button];
    }
}
@end
